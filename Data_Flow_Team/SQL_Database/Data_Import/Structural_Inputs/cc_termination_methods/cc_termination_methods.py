# -*- coding: utf-8 -*-
""" The objective of this script is to import all cover crop termination methods into the CROWN postgresql database. """
...
# set work directory
os.chdir("/Users/amponcet/Documents/GitHub/CROWN/Data_Flow_Team/SQL_Database/Data_Import/Structural_Inputs/cc_termination_methods") 
...
# import data from csv file
with open('cc_termination_methods.csv', newline='') as csvfile:
...
def import_methods(methods_list):
    ...
    sql = "INSERT INTO cc_termination_methods(cc_termination_method) VALUES(%s)" 
    conn = None
