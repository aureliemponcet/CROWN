ImportCCMixtureGA18 <- function(){ # begin function to import cc_mixture
  ...
  loginfo("Table: cc_mixture: GA - Connected to DB", logger = "") # complete log file
  ...
  rm(codes); rm(species); rm(row); rm(subset) # clean workspace
